...
po_facts AS (
    ...
    GROUP BY pb.product_id
        ...
        po_join = ""
        source_note = "Postgres fallback query generated by Step 1 line review module; PO facts skipped"
    if include_sales_facts:
        sales_cte = """
,
sales AS (
    SELECT
...
sales AS (
    SELECT
        NULL::text AS family_part_number,
        0::numeric AS amazon_revenue,
        0::numeric AS shopify_revenue,
        0::numeric AS total_revenue
    WHERE FALSE
)"""
        source_note = "Postgres minimal fallback query generated by Step 1 line review module; sales and PO facts skipped"
...
-- Sales facts included: {str(include_sales_facts).lower()}
WITH params AS (
    SELECT
