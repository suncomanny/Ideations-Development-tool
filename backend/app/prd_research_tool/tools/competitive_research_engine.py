...
def clean_feature_labels(value: Any) -> list[str]:
    ...
    if lowered.startswith("dry") and "damp" in lowered and "only if" in lowered:
        return []
            ...
            compact_dict(
                {
                    ...
                    "product_title": product.get("product_title") or product.get("title"),
                    ...
                    "rating": product.get("reviews_rating"),
                    "review_count": product.get("reviews_count"),
            ...
            "business_case": compact_dict(
                {
                    ...
                    "certifications": clean_certification_labels(business.get("certifications_list")),
